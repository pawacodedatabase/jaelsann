...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-[#1a2d42] to-[#102533] text-white py-12">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              At JAELS FASHION, we deliver elegance and quality. Discover exquisite bags, shoes, 
              jewelry, and apparel designed to enhance your style and confidence.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-6">
          <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} JAELS FASHION. All rights reserved.</p>
