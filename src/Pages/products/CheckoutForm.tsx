...
import { FaBitcoin, FaRegCreditCard, FaUser, FaEnvelope, FaMapMarkerAlt, FaCity, FaClipboard, FaPiggyBank } from 'react-icons/fa';
...
const CheckoutForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    navigate('/cart/history', { state: { fullName: formData.fullName, senderName: formData.senderName, amountSent: formData.amountSent, bankName: formData.bankName, paymentMethod: formData.paymentMethod, orderId, address: formData.address } });
  };
